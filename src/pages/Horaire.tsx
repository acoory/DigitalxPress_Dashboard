...
export default function Horaire_test() {
  ...
  return (
    ...
    >
      <div className="flex space-x-8 mb-4 ">
        <div className="px-4 py-2 bg-[#F8F9FA] rounded-md">
          <button
            className={`px-2 py-1 mr-2 text-dark-blue rounded-md w-36 ${
              selected === 0 ? "bg-white shadow-md " : ""
            }`}
          ...
          <button
            className={`px-2 py-1 ml-2 text-dark-blue rounded-md w-36 ${
              selected === 1 ? "bg-white shadow-md" : ""
            }`}
